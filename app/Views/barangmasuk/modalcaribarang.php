      ...
      <div class="modal-body">
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <button class="btn btn-outline-primary" type="button" id="btnCari"><i class="fa fa-search"></i></button>
          </div>
        </div>
  ...
  function cariDataBarang() {
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.datadetailbarang) {
          $('.viewdetaildata').html(response.datadetailbarang);
        }
      },
